  ...
  <div>
    <form class="form-horizontal form-edit">
      <div class="form-group">
        <label class="col-xs-2 control-label">后台用户昵称：</label>
        <div class="col-xs-6">
          <input class="form-control form-field" v-model="query.nickname" disabled>
        </div>
      </div>
      <div class="form-group">
        <label class="col-xs-2 control-label">后台用户名：</label>
        <div class="col-xs-6">
          <input class="form-control form-field" v-model="query.username" disabled>
        </div>
      </div>
      <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    formSubmit () {
      ...
      this.$network.post(this.$api.user_update_any_password, formData).then(resp => {
